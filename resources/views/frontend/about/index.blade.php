<x-frontend-layout title="{{ __('frontend.about_foundation') }}">
        ...
        <section class="py-12 md:py-16 overflow-hidden"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                ...
                <div class="space-y-4 transition-all duration-700 ease-out transform motion-reduce:transition-none motion-reduce:transform-none"
                    ...
                    <div class="text-base leading-relaxed text-text-primary/70 max-w-prose space-y-4">
                        {!! nl2br(e($oDesc)) !!}
                    </div>
                    <div class="pt-2">
                ...
                @if ($oImg)
                    <div class="relative overflow-hidden rounded-3xl group shadow-sm hover:shadow-md transition-all duration-700 ease-out transform motion-reduce:transition-none motion-reduce:transform-none"
                        ...
                        <div class="aspect-[4/3] w-full bg-[#EAEAE9] dark:bg-gray-800">
    ...
    @if ($establishmentSection)
        ...
        @endphp
        <section class="py-12 md:py-16 border-t border-primary-light/10 overflow-hidden"
                 x-data="{ inView: false }"
                 x-intersect.once="inView = true">
            <div class="rounded-3xl border border-primary-light/15 bg-secondary-light/5 dark:bg-gray-800/10 p-6 sm:p-8 md:p-12 shadow-sm transition-all duration-500 ease-out transform"
    ...
    <section class="pt-12 sm:pt-16 pb-16 border-t border-primary-light/10"
             x-data="{ inView: false }"
             x-intersect.once="inView = true">
        ...
        <div class="space-y-6 lg:space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 lg:gap-8 items-stretch">
                ...
                @if ($visionSection)
                    ...
                    @endphp
                    <div class="col-span-1 md:col-span-1 lg:col-span-3 rounded-3xl border border-primary-light/20 bg-white dark:bg-gray-800 p-8 shadow-sm hover:shadow-md transition-all duration-300 ease-out hover:-translate-y-1 active:scale-[0.99] active:shadow-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-gray-900 transform cursor-default select-none motion-reduce:transition-none motion-reduce:transform-none w-full group"
                         tabindex="0"
                         :class="inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'"
                        ...
                        <div class="flex flex-row items-start gap-4 w-full">
                            ...
                            <div class="space-y-3 flex-1 w-full">
                                <h3 class="text-xl font-bold text-text-primary dark:text-surface leading-snug">
                                    {{ $vTitle }}
                                </h3>
                                <p class="text-base text-text-primary/70 dark:text-gray-300 leading-relaxed font-sans max-w-prose">
                                    {{ $vDesc }}
                                </p>
                            </div>
                ...
                @if ($missionSection)
                    ...
                    @endphp
                    <div class="col-span-1 md:col-span-1 lg:col-span-2 rounded-3xl border border-primary-light/20 bg-white dark:bg-gray-800 p-8 shadow-sm hover:shadow-md transition-all duration-300 ease-out hover:-translate-y-1 active:scale-[0.99] active:shadow-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-gray-900 transform cursor-default select-none motion-reduce:transition-none motion-reduce:transform-none w-full group"
                         tabindex="0"
                         :class="inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'"
                        ...
                        <div class="flex flex-row items-start gap-6 w-full">
                            ...
                            {{-- Image Container (Second in LTR layout) --}}
                            @if ($mImg)
                                <div class="w-14 h-14 rounded-2xl bg-secondary-light/40 dark:bg-primary-light/20 flex items-center justify-center shrink-0 transition-all duration-300 group-hover:bg-secondary-light/60 dark:group-hover:bg-primary-light/30 shadow-sm p-2">
                                    ...
                                    <ul class="space-y-4 mt-4 w-full">
                                        @foreach ($gGoals as $item)
                                            <li class="flex items-start gap-4">
                                                ...
                                                <span class="text-base text-text-primary/70 dark:text-gray-300 leading-relaxed font-sans flex-1">
                                                    {{ $item['text'] }}
                                                </span>
                                            </li>
                                        @endforeach
                    ...
                    <div class="col-span-1 md:col-span-1 lg:col-span-2 rounded-3xl border border-primary-light/20 bg-white dark:bg-gray-800 p-8 shadow-sm hover:shadow-md transition-all duration-300 ease-out hover:-translate-y-1 active:scale-[0.99] active:shadow-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-gray-900 transform cursor-default select-none motion-reduce:transition-none motion-reduce:transform-none w-full group"
                        ...
                        <div class="flex flex-row items-start gap-6 w-full">
                            ...
                            <div class="space-y-3 flex-1 w-full">
                                ...
                                @if (!empty($vaValues))
                                    <div class="space-y-4 mt-4 w-full">
                                        @foreach ($vaValues as $val)
                                            <div class="space-y-1">
                                                <h4 class="text-base font-bold text-primary dark:text-primary-light">
                                                    {{ $val['title'] }}
                                                </h4>
                                                <p class="text-sm text-text-primary/70 dark:text-gray-300 leading-relaxed font-sans max-w-prose">
                                                    {{ $val['desc'] }}
                                                </p>
                                            </div>
                                        @endforeach
                                ...
                                @else
                                    <div class="text-base text-text-primary/70 dark:text-gray-300 leading-relaxed font-sans max-w-prose">
                                        {!! nl2br(e($vaDesc)) !!}
                                    </div>
                                @endif
                            </div>
                ...
                <div class="rounded-3xl border border-primary-light/15 bg-secondary-light/5 dark:bg-gray-800/10 p-6 sm:p-8 md:p-12 shadow-sm transition-all duration-500 ease-out transform"
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                        ...
                        <div class="space-y-6 transition-all duration-700 ease-out transform motion-reduce:transition-none motion-reduce:transform-none"
                             :class="inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'">
                            @if ($title)
                                <h2 class="text-2xl sm:text-3xl font-bold text-text-primary dark:text-surface leading-snug border-s-4 border-primary ps-4">
                                    {{ $title }}
                                </h2>
                            @endif

                            @if ($desc)
                                <div class="text-base text-text-primary/70 dark:text-gray-300 leading-relaxed space-y-4 font-sans">
                                    {!! nl2br(e($desc)) !!}
                                </div>
                            @endif
    ...
    <div class="mt-24 pt-16 border-t border-primary-light/20 text-center max-w-2xl mx-auto space-y-6"
         x-data="{ inView: false }"
         x-intersect.once="inView = true"
         :class="inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'"
         class="transition-all duration-500 ease-out transform">
        <h3 class="text-xl sm:text-2xl font-bold text-text-primary dark:text-gray-100">
            {{ $locale === 'ar' ? 'فريق العمل والقيادة' : 'Our Team & Leadership' }}
        </h3>
        <p class="text-sm text-text-primary/70 dark:text-gray-400 max-w-md mx-auto leading-relaxed">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-md mx-auto pt-2">
            ...
            <x-frontend.button :href="route('about.executive-team')" variant="outline" class="w-full justify-center py-3.5 rounded-2xl hover:bg-primary/10 transition-all duration-300 active:scale-[0.98]">
