        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8"
            ...
            @foreach ($surveys as $index => $survey)
                @php
                    ...
                    $borderColors = ['border-primary', 'border-secondary', 'border-secondary', 'border-[#A38B54]/60'];
                    ...
                    if (!$survey->is_active) {
                        ...
                        $statusClass = 'bg-gray-400 text-background';
                        $isClosed = true;
                ...
                <div class="rounded-3xl border border-secondary/15 bg-background dark:bg-gray-800 shadow-sm hover:shadow-md transition-all duration-300 ease-out hover:-translate-y-1 active:scale-[0.99] select-none motion-reduce:transition-none w-full flex flex-col justify-between overflow-hidden border-s-4 {{ $borderColor }} group"
                    ...
                    <div>
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div class="flex flex-wrap items-center justify-between gap-2">
                                <span class="px-3 py-1 rounded-full text-xs font-semibold bg-secondary/40 text-primary">
                    ...
                    <div class="px-6 pb-6 pt-2">
                        @if ($isClosed)
                            <button disabled class="w-full py-3 rounded-2xl bg-background dark:bg-gray-700 text-gray-400 font-bold text-sm cursor-not-allowed text-center">
