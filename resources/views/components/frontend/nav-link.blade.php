...
$classes = ($active ?? false)
    ...
    : 'inline-flex items-center px-2 py-2 font-navbar text-[15px] font-semibold text-text-secondary dark:text-gray-300 hover:text-primary-light dark:hover:text-primary-light transition-all duration-150 ease-in-out focus:outline-none';
@endphp
