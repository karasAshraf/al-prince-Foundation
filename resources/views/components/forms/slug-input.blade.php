...
>
    ...
    <input
        ...
        {{ $required ? 'required' : '' }}
        {{ $attributes->merge([
            'class' => 'w-full rounded-lg border border-[#B49C6E]/40 bg-secondary px-3.5 py-2.5 text-sm text-[#3D342A] focus:border-[#A38B54] focus:outline-none focus:ring-1 focus:ring-[#A38B54] read-only:bg-secondary/20'
        ]) }}
    >
