...
<div>
    ...
    <input
        ...
        {{ $attributes->merge([
            'class' => "w-full min-h-[44px] rounded-xl bg-secondary px-3.5 py-2.5 text-sm text-[#3D342A] placeholder-[#3D342A]/40 transition duration-200 focus:outline-none disabled:opacity-50 disabled:bg-secondary/20 disabled:cursor-not-allowed {$borderClasses}"
        ]) }}
    >
