...
<div class="flex flex-col items-center justify-center rounded-xl border border-dashed border-[#B49C6E]/40 bg-[#EAEAE9]/10 px-6 py-16 text-center">
    ...
    @if($actionLabel && $actionUrl)
        <x-buttons.primary onclick="window.location='{{ $actionUrl }}'">
            {{ $actionLabel }}
        </x-buttons.primary>
    @endif
</div>
