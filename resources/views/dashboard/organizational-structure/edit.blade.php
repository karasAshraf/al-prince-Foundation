...
@section('content')
    ...
    <form method="POST" action="{{ route('dashboard.organizational-structure.update') }}" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="rounded-xl border border-[#B49C6E]/20 bg-[#EAEAE9] p-5">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                        class="w-full rounded-lg border border-[#B49C6E]/40 bg-white px-3.5 py-2 text-sm text-[#3D342A] shadow-sm focus:border-[#A5780A] focus:outline-none"
                    />
                    @error('title_ar')
            ...
            <div class="mt-5 flex items-center gap-2">
                <input
                    ...
                    class="h-4.5 w-4.5 rounded border-[#B49C6E]/40 text-[#A5780A] focus:ring-[#A5780A]"
                />
            ...
            <div class="rounded-xl border border-[#B49C6E]/20 bg-[#EAEAE9] p-5">
                ...
                @if ($imgArUrl)
                    <div class="mb-4">
                        ...
                        <div class="relative inline-block overflow-hidden rounded-lg border border-[#B49C6E]/40 bg-white p-2">
                            <img src="{{ $imgArUrl }}" alt="Arabic chart" class="max-h-48 max-w-full object-contain" />
                        </div>
                        <div class="mt-2.5 flex items-center gap-2">
                            <input type="checkbox" name="remove_image_ar" id="remove_image_ar" value="1" class="h-4 w-4 rounded border-[#B49C6E]/40 text-[#A5780A]" />
                ...
                <div class="mt-2">
                    ...
                    <input
                        ...
                        class="block w-full text-xs text-[#3D342A] file:me-3 file:rounded-md file:border-0 file:bg-[#A5780A] file:px-3 file:py-1.5 file:text-xs file:font-semibold file:text-white hover:file:bg-[#AC8321]"
                    />
            ...
            <div class="rounded-xl border border-[#B49C6E]/20 bg-[#EAEAE9] p-5">
                ...
                @if ($imgEnUrl)
                    <div class="mb-4">
                        ...
                        <div class="mt-2.5 flex items-center gap-2">
                            <input type="checkbox" name="remove_image_en" id="remove_image_en" value="1" class="h-4 w-4 rounded border-[#B49C6E]/40 text-[#A5780A]" />
        ...
        <div class="flex items-center justify-end gap-3 border-t border-[#B49C6E]/20 pt-4">
            <button
                type="submit"
                class="rounded-lg bg-[#A5780A] px-5 py-2.5 text-sm font-semibold text-white shadow hover:bg-[#AC8321] active:scale-[0.98] transition-all"
            >
