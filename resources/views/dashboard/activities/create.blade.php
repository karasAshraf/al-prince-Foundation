...
@section('title', __('dashboard.activities.create'))

@php
    $breadcrumbs = [
        ['label' => __('dashboard.activities.title'), 'url' => route('dashboard.activities.index')],
        ['label' => __('dashboard.activities.create'), 'url' => null],
    ];
@endphp
...
@section('content')
    ...
    <div class="mb-6 flex items-center justify-between">
        <h1 class="text-xl font-bold text-[#3D342A]">{{ __('dashboard.activities.create') }}</h1>
