...
return [
    ...
    */
    'common' => [
        ...
        'top_navbar_aria' => 'Top Navigation Bar',
        'open_sidebar' => 'Open Sidebar Menu',
        'foundation_name' => 'Prince Abdulrahman Foundation',
        'validation_errors' => 'There are input validation errors:',
        'success' => 'Success',
        'error' => 'Error',
    ...
    */
    'sidebar' => [
        ...
        'users' => 'Users',
        'settings' => 'Settings',
        'advertising_center' => 'Advertising Center',
    ...
    */
    'activities' => [
        ...
        'gallery_hint' => 'You can upload multiple gallery images',
    ...
    */
    'industries' => [
        ...
        'no_industries' => 'No industries added yet.',
    ],
    ...
    */
    'solutions' => [
        ...
        'no_solutions' => 'No solutions added yet.',
    ],
    ...
    */
    'team_members' => [
        ...
        'type_board' => 'Board of Directors',
        'type_executive' => 'Executive Team',
    ...
    */
    'governance_documents' => [
        ...
        'file_size' => 'File Size',
        'publish_date' => 'Issue / Publish Date',
        'status' => 'Document Status',
        'no_documents' => 'No governance documents added yet.',
        'categories' => [
            'policies' => 'Policies',
            'financial_reports' => 'Financial Report',
            'achievement_reports' => 'Achievement Report',
        ],
    ],
    ...
    */
    'surveys' => [
        ...
        'single' => 'Survey',
        'list' => 'Survey List',
        'create' => 'Add New Survey',
        'edit' => 'Edit Survey',
        'show' => 'View Survey',
        'responses' => 'Survey Responses',
        'delete' => 'Delete Survey',
        'survey_title' => 'Survey Title',
        'type' => 'Survey Category / Type',
        'description' => 'Survey Description',
        'status' => 'Survey Status',
        'responses_count' => 'Responses Count',
        'questions' => 'Survey Questions',
        'questions_subtitle' => 'Add and configure questions and their options',
        'add_question' => '+ Add Question',
        'question_title' => 'Question text in Arabic...',
        ...
        'no_surveys' => 'No surveys added yet.',
        'no_responses' => 'No responses recorded for this survey.',
        'timing_and_status' => 'Survey Schedule & Status',
        'starts_at' => 'Start Date',
        'ends_at' => 'End Date',
        'is_active_label' => 'Survey is active and ready for responses',
        'media_label' => 'Survey Media (Image / Video)',
        'save_survey' => 'Save Survey',
        'survey_data' => 'Survey Data',
        'responses_results' => 'Survey Responses & Results',
        ...
        'success_created' => 'Survey created successfully',
        'success_updated' => 'Survey updated successfully',
        'success_deleted' => 'Survey deleted successfully',
    ...
    */
    'contact_messages' => [
        ...
        'no_messages' => 'No contact messages received yet.',
    ],
    ...
    */
    'settings' => [
        ...
        'general_settings' => 'General Organization Info',
        ...
        'location_name_ar' => 'Location Name (AR)',
    ...
    */
    ...
    'about_section_content' => 'Section Content',
    'contact_message_reply' => 'Reply to Message',
    ...
    'media_library' => [
        ...
        'edit' => 'Edit File',
        'delete' => 'Delete File',
        'no_items' => 'No files added yet.',
        'file' => 'File',
        'category' => 'File Category',
        'title_ar' => 'File Title (AR)',
        'title_en' => 'File Title (EN)',
        'desc_ar' => 'File Description (AR)',
        'desc_en' => 'File Description (EN)',
        'search_placeholder' => 'Search by title',
        'all_categories' => 'All Categories',
        'external_link' => 'External Link',
        'download_file' => 'Download File',
        'file_or_link' => 'Document File or External Link',
        'type_file' => 'Type / File',
        'empty_state' => 'No files have been added to the media library yet.',
    ],

    'hero_slides' => [
        'title' => 'Hero Slides',
        'single' => 'Hero Slide',
        'list' => 'Manage Hero Slides',
        ...
        'order' => 'Order',
        'status' => 'Status',
        'filter_placement' => 'Filter by placement (Page)',
        'all_pages' => 'All Pages',
        'cancel_filter' => 'Clear Filter',
        'no_slides' => 'No hero slides added yet.',
        'slides_desc' => 'You can add and customize animated hero photo slides for various pages of the site from here.',
        'add_slide' => 'Add Slide',
        ...
        'button_url' => 'Button Action URL',
        'button_url_placeholder' => 'Optional link',
        'settings' => 'Settings',
        'is_active_label' => 'Active and visible in frontend',
        'slide_details' => 'Slide Details',
        'button_details' => 'Button Action (Optional)',
        'success_create' => 'Hero slide added successfully',
        'success_update' => 'Hero slide updated successfully',
        'success_delete' => 'Hero slide deleted successfully',
        'placements' => [
            'home' => 'Home',
            'about' => 'About Us',
            'activities' => 'Activities',
